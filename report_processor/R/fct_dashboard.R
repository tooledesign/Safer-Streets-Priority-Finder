...
tryCatch({
  ...
  error = function(cond){
    print("There was an error with, cr_collector()")
    print(cond)
  })
}
...
get_fit_data <- function(connection, table, est_columns, column_rename, user_id, run_id, mode){
  ...
  error = function(cond){
    print("There was an error with, get_fit_data()")
    print(cond)
  })
}
...
get_crashes_sev_fclass <- function(table, filter){
 ...
 error = function(cond){
   print("There was an error with, get_crashes_sev_fclass()")
   print(cond)
 })
}
...
get_dangerous_locations <- function(c, the_input, user_id, run_id){
  ...
  error = function(cond){
    print("There was an error with, get_dangerous_locations()")
    print(cond)
  })
}
...
get_crashes <- function(c, user_id, run_id){
  ...
  error = function(cond){
    print("There was an error with, get_crashes()")
    print(cond)
  })
}
...
get_roads <-function(c, user_id, run_id){
  ...
  error = function(cond){
    print("There was an error with, get_roads()")
    print(cond)
  })
}
...
error = function(cond){
  print("There was an error with, get_modeloutputs()")
  print(cond)
})
}
