...
p("For more detailed information on model development and calibration beyond what is included below please see the", HTML("<a href=\"./final_report\" target=\"_blank\"style=\"color: #007bff;\">technical report</a>"), "documenting development of the SSPF."),
