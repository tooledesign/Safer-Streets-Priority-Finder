  ...
  tagList(
    ...
    bs4Card(inputId=ns('intro_card'), title='Introduction', width = 12, closable = F,
            tags$ul(
              ...
              tags$li("Using FARS data may produce unexpected or unhelpful results. If you have access to crash data containing more than just fatal crashes, we recommend you use it. Because the default FARS data only includes fatalities, it is not ideal for the analyses within the SSPF. If you have access to any kind of geocoded crash data, we strongly recommend using this data, even if it requires some time on the front end to clean this data up to meet the data requirements listed above."),
