...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/nola_prior_crashes_2_reduce2-01.png?raw=true", alt="nola ped hotspot", width = "100%"), style='max-width:926px;')),
...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/nola_ped_crash_score_w_study_reduce2.png?raw=true", alt="nola ped crash density screenshot", width = "100%"), style='max-width:1094px;')),
...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/nola_bike_crash_score_w_study_reduce.png?raw=true", alt="nola bike crash density screenshot", width = "100%"), style='max-width:1102px;')),

p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/nola_other_crash_score_w_study_reduce.png?raw=true", alt="nola other crash density screenshot", width = "100%"), style='max-width:1104px;')),
...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/nola_ped_crash_costs_w_study3.PNG?raw=true", alt="nola ped crash costs screenshot", width = "100%"), style='max-width:1094px;')),

p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/nola_bike_crash_costs_w_study3.PNG?raw=true", alt="nola bike crash costs screenshot", width = "100%"), style='max-width:1099px;')),
...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/nola_rta_reduce.png?raw=true", alt="nola transit stops and ped crash costs screenshot", width = "100%"), style='max-width:762px;')),
...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/lincoln_ped_crash_score_w_study_reduce.png?raw=true", alt="lincoln ped crash density screenshot", width = "100%"), style='max-width:1092px;')),

p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/lincoln_bike_crash_score_w_study_reduce.png?raw=true", alt="lincoln bike crash density screenshot", width = "100%"), style='max-width:1091px;')),

p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/lincoln_other_crash_score_w_study_reduce.png?raw=true", alt="lincoln other crash density screenshot", width = "100%"), style='max-width:1089px;')),
...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/lincoln_ped_crash_costs_w_study_gis.png?raw=true", alt="lincoln ped crash costs screenshot", width = "100%"), style='max-width:1098px;')),

p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/lincoln_bike_crash_costs_w_study_gis.png?raw=true", alt="lincoln bike crash costs screenshot", width = "100%"), style='max-width:1098px;')),
...
p(tags$div(img(src="https://github.com/tooledesign/Safer-Streets-Priority-Finder/blob/main/safer_streets_priority_finder/img/lincoln_bike_crash_score_facilities_reduce.png?raw=true", alt="lincoln bike crash costs with facilities screenshot", width = "100%"), style='max-width:919px;')),
